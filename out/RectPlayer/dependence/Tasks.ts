...
class AjaxTask extends BaseAsyncTask {
    ...
    constructor(option: AjaxOption) {
        super();
        this.Arg = new TaskArgs(null);
        this.Arg.stepresult = option;
    }

    public Execute(): void {
        let option: AjaxOption = this.Arg.stepresult;
            ...
            this._xhr.onreadystatechange = () => {
                if (this._xhr.readyState === 4) {
                    ...
                    if (AjaxTask.root().indexOf("file:///") == 0) {
                        if (option.responseType === "text") this.success(this._xhr.responseText);
